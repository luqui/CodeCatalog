...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VersionPtr.votes'
        db.delete_column('zoo_versionptr', 'votes')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'VersionPtr.votes'
        db.add_column('zoo_versionptr', 'votes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
