...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VersionPtr.type'
        db.add_column('zoo_versionptr', 'type', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VersionPtr.type'
        db.delete_column('zoo_versionptr', 'type')
