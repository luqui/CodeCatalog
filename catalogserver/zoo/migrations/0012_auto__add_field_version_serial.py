...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Version.serial'
        db.add_column('zoo_version', 'serial', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Version.serial'
        db.delete_column('zoo_version', 'serial')
