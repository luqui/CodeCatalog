...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Version.approved'
        db.delete_column('zoo_version', 'approved')
    
    
    def backwards(self, orm):
        
        # Adding field 'Version.approved'
        db.add_column('zoo_version', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
