...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('zoo_following', (
            ('new_events', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('follower', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('followed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zoo.VersionPtr'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_check', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('zoo', ['Following'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Following'
        db.delete_table('zoo_following')
