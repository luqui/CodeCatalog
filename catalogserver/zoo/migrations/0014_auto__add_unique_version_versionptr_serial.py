...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Version', fields ['versionptr', 'serial']
        db.create_unique('zoo_version', ['versionptr_id', 'serial'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'Version', fields ['versionptr', 'serial']
        db.delete_unique('zoo_version', ['versionptr_id', 'serial'])
    ...
    models = {
        ...
        'zoo.version': {
            'Meta': {'unique_together': "(('versionptr', 'serial'),)", 'object_name': 'Version'},
