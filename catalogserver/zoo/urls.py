...
apipatterns = patterns('',
    ...
    (r'^spec/(?P<versionptr>\d+)/(?P<serial>\d+)/$', jsonwrap(api.spec)),
    ...
    (r'^snippet/(?P<versionptr>\d+)/(?P<serial>\d+)/$', jsonwrap(api.snippet)),
    (r'^snippet/(?P<versionptr>\d+)/(?P<serial>\d+)/assemble/$', jsonwrap(api.snippet_assemble)),
    (r'^bugs/(?P<versionptr>\d+)/all/$', jsonwrap(api.bugs_all)),
    (r'^bug/(?P<versionptr>\d+)/(?P<serial>)/$', jsonwrap(api.bug)),
...
urlpatterns = patterns('',
    ...
    (r'^(?P<versionptr>\d+)/(?P<serial>\d+)/$', views.version),
    (r'^new/$', views.new),
    (r'^profile/$', views.profile),
    (r'^faq/$', views.faq),
    (r'^tools/$', views.tools),
    (r'^new_events/$', views.new_events),
